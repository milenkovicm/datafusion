    ...
    fn try_into_physical_plan(
        ...
        match plan {
            ...
            PhysicalPlanType::SortMergeJoin(sort_join) => {
                self.try_into_sort_join(sort_join, registry, runtime, extension_codec)
            }
        }
    }
...
impl protobuf::PhysicalPlanNode {
    ...
    fn try_into_sort_join(
        ...
        let left =
            into_physical_plan(&sort_join.left, registry, runtime, extension_codec)?;
        let left_schema = left.schema();
        let right =
            into_physical_plan(&sort_join.right, registry, runtime, extension_codec)?;
        let right_schema = right.schema();
